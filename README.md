...
The Lambda function itself needs:
...
* Get a list of Route 53 private zones
* Get a list of tags for each zone
...
```bash
aws cloudformation delete-stack --stack-name route53-zone-association
```
